...
|Today's date | Date dt = new Date(); | **LocalDate dt = LocalDate.now();** |
|Today's date & time | Date dt = new Date(); | **LocalDateTime dt = LocalDateTime.now();** |
...
```java
        ...
        System.out.println(dt.plusDays(2)); // 2017-01-03T12:00
```        
